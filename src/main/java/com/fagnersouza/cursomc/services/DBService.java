...
import com.fagnersouza.cursomc.domain.Cidade;
import com.fagnersouza.cursomc.domain.Cliente;
import com.fagnersouza.cursomc.domain.Endereco;
...
import com.fagnersouza.cursomc.domain.PagamentoComCartao;
import com.fagnersouza.cursomc.domain.Pedido;
import com.fagnersouza.cursomc.domain.Produto;
import com.fagnersouza.cursomc.domain.enums.EstadoPagamento;
import com.fagnersouza.cursomc.domain.enums.Perfil;
import com.fagnersouza.cursomc.domain.enums.TipoCliente;
import com.fagnersouza.cursomc.repositories.CategoriaRepository;
import com.fagnersouza.cursomc.repositories.CidadeRepository;
import com.fagnersouza.cursomc.repositories.ClienteRepository;
import com.fagnersouza.cursomc.repositories.EnderecoRepository;
...
import com.fagnersouza.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Fagner Souza", "souza.fagner1989@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "9383893"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "fagner.roberto89@gmail.com", "20073885029", TipoCliente.PESSOAFISICA, pe.encode("123"));
